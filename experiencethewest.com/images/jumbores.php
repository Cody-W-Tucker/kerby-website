...
<table width="782" border="1" align="center" bordercolor="#660000" bgcolor="#FFFFFF">
  <tr>
    <td width="772" height="242" valign="top"> 
      ...
      <p align="center"> 
      <form enctype='multipart/form-data' action='jumbores/process.php' method='post'>
        <table width="623" border="1" align="center" cellpadding="5" cellspacing="1" bordercolor="#000066" style="border-collapse: collapse">
          ...
          <tr> 
            <td colspan="3" bgcolor="#B5CBEF" height="17" bordercolor="#FFFFFF" background="images/tile_back.gif"> 
              <p align="left"><b><font face="arial" size="2" color="#FFFFFF"><img border="0" src="images/nav_m.gif" width="8" height="8"> 
                <font face='Arial, Helvetica, sans-serif' size=2 color='#FFFFFF'><strong>Jumbo 
                Calendar Reservation/Order Form</strong></font></td>
          </tr>
          <tr> 
            <td colspan="3" bgcolor="#B5CBEF" height="16" bordercolor="#FFFFFF" background="images/tile_sub.gif"><div align="center"><font size="2" face="Verdana"><b><font size="3" face="Arial, Helvetica, sans-serif" align="left"><strong>Reserve 
            yours today! Nothing is due until November 1, 2016.</strong></font></b></font></div></td>
          </tr>
          <tr> 
          ...
          <tr> 
            ...
            <td width="202" valign="top" bordercolor="#FFFFFF" bgcolor="#EFF3F7"><div align="center"> 
                <p><a href="images/2017 Images/Custom Hangers/Custom jpg/Cowboys_Heaven_Ad_17_new_full.jpg"><img src="images/2017 Images/Custom Hangers/Custom jpg/Cowboys_Heaven_Ad_17_new_2.jpg" width="200" height="288" border="0"></a></p>
                <p><font size="2" face="Arial, Helvetica, sans-serif"> 
                  <input type=radio name='CalendarStyle' value='Style #HE11' checked>
                  Style # HE11<br />
                  Counting Yearlings
                  </font></p>
              </div></td>
            <td width="211" height="30" valign="top" bordercolor="#FFFFFF" bgcolor="#EFF3F7"> 
              <div align="center"> 
                <p><a href="images/2017 Images/Custom Hangers/Custom jpg/Counting_Yearlings_Ad_17_full.jpg"><img src="images/2017 Images/Custom Hangers/Custom jpg/Counting_Yearlings_Ad_17_2.jpg" width="200" height="288" border="0"></a></p>
                <p><font size="2" face="Arial, Helvetica, sans-serif"> 
                  <input type=radio name='CalendarStyle' value='Style #CY10' >
                  Style # CY10<br />
                  Changing Pastures
                  </font></p>
              </div></td>
