...
#pt_register('POST','CalendarYear');
#pt_register('POST','Quantityof2007Calendars');
#pt_register('POST','QuantityofEnvelopes');
...
if($CalendarYear =="" || $QuantityofCalendars=="" || $QuantityofEnvelopes=="" || $CompanyorOrganization=="" || $Attention=="" || $StreetAddress=="" || $City=="" || $StateorProvince=="" || $ZiporPostalCode=="" || $Phone=="" || $Email=="" ){
  ...
  if($StreetAddress==""){$error.="<li>Address";}
  if($City==""){$error.="<li>City";}
  if($StateorProvince==""){$error.="<li>State or Province";}
...
mail("Experience.Howdybob@myoutlookonline.com","Reserve 2007 Calendar",$message,"From: noreply@experiencethewest.com");
#mail("Experience.Howdybob@myoutlookonline.com","Reserve Calendar 2008",$message,"From: noreply@experiencethewest.com");
mail("photo@dl-photo.com","Reserve 2007 Calendar",$message,"From: noreply@experiencethewest.com");
?>


<!-- This is the content of the Thank you page, be careful while changing it -->

<h2 align="center"><font face="Arial, Helvetica, sans-serif">Thank you!</font><br>
  <font size="2" face="Arial, Helvetica, sans-serif">PRINT THIS PAGE FOR YOUR RECORDS</font></h2>
...
<table width=55% align="center">
  ...
  <tr> 
    <td colspan="2"><P class=MsoNormal style="MARGIN: 0in 0in 0pt"><span class="style19"><font size="2" face="Arial, Helvetica, sans-serif"><br>
        <strong>Thank you for ordering the 2007 Range Riders calendars.&nbsp; 
        We will provide a proof with your&nbsp;information formatted in an attractive 
        layout within 10 days.&nbsp; We will then proceed with&nbsp;production.&nbsp; 
        </strong></font></span></P>
      <P class=MsoNormal  style19 style="MARGIN: 0in 0in 0pt" style5><font size="2" face="Arial, Helvetica, sans-serif">&nbsp;<o:p></o:p></font></P>
      <P class=MsoNormal  style19 style="MARGIN: 0in 0in 0pt" style5><font size="2" face="Arial, Helvetica, sans-serif">&nbsp;&nbsp;&nbsp; 
        &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; If any of the above information 
        is incorrect or after you receive your proof there are revisions,&nbsp;please 
        contact us immediately at <strong>1-800-657-2149.</strong></font></P>
      <P class=MsoNormal  style19 style="MARGIN: 0in 0in 0pt" style5><font size="2" face="Arial, Helvetica, sans-serif">&nbsp;<o:p></o:p></font></P>
      <P class=MsoNormal  style19 style="MARGIN: 0in 0in 0pt" style5><font size="2" face="Arial, Helvetica, sans-serif">&nbsp;&nbsp;&nbsp; 
        &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; It is our pleasure to serve you.<SPAN style="mso-spacerun: yes">&nbsp; 
        </SPAN>Have a Blessed Day!</font></P>
      <P class=MsoNormal  style19 style="MARGIN: 0in 0in 0pt" style5><font size="2" face="Arial, Helvetica, sans-serif">&nbsp;<o:p></o:p></font></P>
      <P class=MsoNormal  style19 style="MARGIN: 0in 0in 0pt" style5><font size="2" face="Arial, Helvetica, sans-serif">&nbsp;&nbsp;&nbsp; 
        &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; Clint Kerby</font></P>
      <P class=style20 style="MARGIN: 0in 0in 0pt"><font size="2" face="Arial, Helvetica, sans-serif">&nbsp;&nbsp;&nbsp; 
        &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;<strong><em>&nbsp;</em></strong><em> Owner</em></font></P>
