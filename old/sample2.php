...
<div class="mc-field-group">
	<label for="mce-ATTENTION">Attention  <span class="asterisk">*</span>
</label>
<input type="text" value="" name="ATTENTION" class="required" id="mce-ATTENTION">
</div>
<div class="mc-address-group">
	<div class="mc-field-group">
	    <label for="mce-ADDRESS-addr1">Street Address  <span class="asterisk">*</span>
</label>
...
<div class="mc-field-group size1of2">
	<label for="mce-QUAN">Quantity Anticipated </label>
